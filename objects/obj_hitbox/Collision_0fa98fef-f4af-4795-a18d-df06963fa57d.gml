/// @description Destroy object if collision found with a solid interactable object
// If the interactable object is marked as solid, destroy the hitbox upon collision assuming
// it should be destroyed.
if other.interactableSolid {
	...
	// Destroy the hitbox if it collides with a wall AND its a projectile or something that
	// should be destroyed upon collision.
	if owner_is_player_ {
