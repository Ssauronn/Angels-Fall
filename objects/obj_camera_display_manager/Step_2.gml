...
var move_to_x_ = round_to_n_multiple((camera_get_view_x(view_camera[0]) + ((target_x_ - current_x_) / 10)), round_x_);
var move_to_y_ = round_to_n_multiple((camera_get_view_y(view_camera[0]) + ((target_y_ - current_y_) / 10)), round_x_);
