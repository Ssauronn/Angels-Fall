function scr_player_wrath_of_the_repentant() {
	...
	if instance_exists(obj_player) {
		if playerImageIndex > 5 {
			obj_skill_tree.wrathOfTheRepentantActive = true;
			obj_skill_tree.wrathOfTheRepentantTimer = obj_skill_tree.wrathOfTheRepentantTimerStartTime;
		}
