function scr_player_lightning_spear() {
	...
	if instance_exists(obj_player) {
		if (!hitboxCreated) && (playerImageIndex > 2) {
			...
			playerHitbox.playerHitboxAbilityOrigin = "Lightning Spear";
			playerHitbox.playerHitboxHeal = false;
			playerHitbox.playerHitboxValue = obj_skill_tree.lightningSpearDamage;
