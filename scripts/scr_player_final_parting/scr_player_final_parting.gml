function scr_player_final_parting() {
		...
		if (!hitboxCreated) && (playerImageIndex > 2) {
			...
			switch (playerDirectionFacing) {
				case playerdirection.right:
					...
					var point_direction_ = point_direction(x + 32, y, obj_skill_tree.finalPartingTargetXPos, obj_skill_tree.finalPartingTargetYPos);
					break;
				case playerdirection.up:
					playerHitbox = instance_create_depth(x, y - 32, -999, obj_hitbox);
					var point_direction_ = point_direction(x, y - 32, obj_skill_tree.finalPartingTargetXPos, obj_skill_tree.finalPartingTargetYPos);
					break;
			...
			playerHitbox.playerProjectileHitboxSpeed = obj_skill_tree.finalPartingSpeed;
			...
			playerHitbox.playerHitboxAbilityOrigin = "Final Parting";
			playerHitbox.playerHitboxHeal = false;
			playerHitbox.playerHitboxValue = obj_skill_tree.finalPartingDamage;
