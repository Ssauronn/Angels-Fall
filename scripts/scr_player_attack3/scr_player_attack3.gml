function scr_player_attack3() {
	...
	if instance_exists(obj_player) {
		if (!hitboxCreated) && (playerImageIndex > 2) {
			...
			playerHitbox.playerHitboxValue = playerMeleeAttackThreeValue;
