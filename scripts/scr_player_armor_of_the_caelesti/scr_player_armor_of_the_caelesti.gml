function scr_player_armor_of_the_caelesti() {
	...
	if instance_exists(obj_player) {
		if playerImageIndex > 7 {
			obj_skill_tree.armorOfTheCaelestiActive = true;
			obj_skill_tree.armorOfTheCaelestiTimer = obj_skill_tree.armorOfTheCaelestiTimerStartTime;
		}
