function scr_player_risk_of_life() {
		...
		if (!hitboxCreated) && (playerImageIndex > 2) {
			...
			switch (playerDirectionFacing) {
				case playerdirection.right:
					...
					var point_direction_ = point_direction(x + 32, y, obj_skill_tree.riskOfLifeTargetXPos, obj_skill_tree.riskOfLifeTargetYPos);
					break;
				case playerdirection.up:
					playerHitbox = instance_create_depth(x, y - 32, -999, obj_hitbox);
					var point_direction_ = point_direction(x, y - 32, obj_skill_tree.riskOfLifeTargetXPos, obj_skill_tree.riskOfLifeTargetYPos);
					break;
			...
			playerHitbox.playerProjectileHitboxSpeed = obj_skill_tree.riskOfLifeSpeed;
			...
			playerHitbox.playerHitboxAbilityOrigin = "Risk of Life";
			playerHitbox.playerHitboxHeal = false;
			playerHitbox.playerHitboxValue = obj_skill_tree.riskOfLifeDirectHitDamage;
