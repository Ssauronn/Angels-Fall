function scr_player_true_caelesti_wings() {
	...
	if instance_exists(obj_player) {
		if playerImageIndex > 5 {
			obj_skill_tree.trueCaelestiWingsActive = true;
			obj_skill_tree.trueCaelestiWingsTimer = obj_skill_tree.trueCaelestiWingsTimerStartTime;
		}
